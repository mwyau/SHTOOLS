...
| Function name | Description |
| ------------- | ----------- |
| [SHExpandCC](pyshexpandcc.html) | Expand a real Clenshaw-Curtis grid into spherical harmonics. |
| [MakeGridCC](pymakegridcc.html) | Create a real Clenshaw-Curtis grid from spherical harmonic coefficients. |
| [SHExpandCCC](pyshexpandccc.html) | Expand a complex Clenshaw-Curtis grid into complex spherical harmonics. |
| [MakeGridCCC](pymakegridccc.html) | Create a complex Clenshaw-Curtis grid from complex spherical harmonic coefficients. |
